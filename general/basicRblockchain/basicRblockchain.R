...
# This is a basic blockchain coded in R using Proof-of-Work methodology.
#
# reference: https://www.datacamp.com/community/tutorials/blockchain-r
...
# 2. Hash using the "Digest" R package
#------------------------------

digest("R" ,"sha256") # Encode the string object "R" using SHA256 hashing
...
# 3. Proof-of-Work (PoW) algorithm which controls the difficulty of creating a new block.
#------------------------------
